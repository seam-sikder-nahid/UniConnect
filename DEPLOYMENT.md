# 🚀 UniConnect v2 — Complete Deployment Guide
...
2. Select your project (`uu-uniconnect`) or create a new one
...
## 🖼️ STEP 2 — Cloudinary Setup (Free Image Hosting)
...
```
Public Key:  sqtwpuaDG-_Y6GtrP
Service ID:  service_uniconnect
Template ID: template_e80f8or
```

But you must verify these are active in your EmailJS dashboard:

1. Login at **https://www.emailjs.com**
2. **Email Services** → confirm `service_uniconnect` is connected to a real email (e.g. Gmail)
3. **Email Templates** → confirm `template_e80f8or` exists
...
# EmailJS (already set — only change if you use different IDs)
VITE_EMAILJS_PUBLIC_KEY=sqtwpuaDG-_Y6GtrP
VITE_EMAILJS_SERVICE_ID=service_uniconnect
VITE_EMAILJS_TEMPLATE_ID=template_e80f8or
```
...
firebase use --add
# Select uu-uniconnect → alias: default

# Build + Deploy everything
npm run deploy
```

Live URL will be: `https://uu-uniconnect.web.app`
...
*UniConnect v2 — Uttara University Digital Hub*
*React 18 · Vite · TailwindCSS · Firebase · Cloudinary · EmailJS*
